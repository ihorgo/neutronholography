...
//  load('c:\mainsci\macros\psi08\psipartsmod.dat');
  ...
  siz=[4/30*50,4/30*50];
  atsarr=MkRecArray(2,4/30,siz,[0,0,0]);
  H1=ReconstHoloArb(atsarr,h.h1,1);
  save('c:\mainsci\macros\psi08\recpsiph1lineplane.dat',H1);
  clear H1;
  mclose('all');

//  load('c:\mainsci\macros\psi08\recpsiph1lineplane.dat');
////  H1s=SymmRecHolo(H1,24);
////  save('c:\mainsci\macros\psi08\recpsiph1.dat',H1,H1s);
//  H1s=HoloCubeSymm(H1,1);
//  save('c:\mainsci\macros\psi08\recpsiph1lineplane.dat',H1,H1s);
//  HH.H=H1;
//  HH.Hs=H1s;
//  clear H1;
//  clear H1s;
